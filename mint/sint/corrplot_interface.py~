...
class CorrplotInterface(MachineInterface):
#class CorrplotInterface(object):
    ...
    def __init__(self, pathToCorrPlotFile = '/u1/lcls/matlab/data/2016/2016-10/2016-10-20/CorrelationPlot-QUAD_IN20_511_BCTRL-2016-10-20-053315.mat', fitOnlyQ=False, drunkenQ=False):
        super(CorrplotInterface, self).__init__()
        ...
        self.setup(pathToCorrPlotFile, fitOnlyQ, drunkenQ)
        
    def setup(self, pathToCorrPlotFile = '/u1/lcls/matlab/data/2016/2016-10/2016-10-20/CorrelationPlot-QUAD_IN20_511_BCTRL-2016-10-20-053315.mat', fitOnlyQ=False, drunkenQ=False):
        ...
        self.pvdict['GDET:FEE1:241:ENRCHSTBR'] = len(self.pvs)-1
    ...
    def get_value(self, variable_names):
        ...
        #else:
        if variable_names == 'GDET:FEE1:241:ENRCHSTBR':
            return np.array([self.get1(variable_names) for i in range(self.points)])
        else:
    ...
    def fin(self, x_new): # let this method update means and stdevs
        ...
        print('self.x, self.y, self.mean, self.stdev = ',self.x, self.y, self.mean, self.stdev)
